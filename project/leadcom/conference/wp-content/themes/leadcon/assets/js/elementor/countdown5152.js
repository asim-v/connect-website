        ...
        var comingSoon = function comingSoon() {
            ...
            countdowns.forEach(function(countdownContainer) {
                ...
                var countdown = Doom({
                    ...
                    ids: {
                        days: digits[0].querySelector('.leadcon-countdown-digit').id,
                        hours: digits[1].querySelector('.leadcon-countdown-digit').id,
                        mins: digits[2].querySelector('.leadcon-countdown-digit').id,
                        secs: digits[3].querySelector('.leadcon-countdown-digit').id
                    }
                });
                countdown.doom();
            });
